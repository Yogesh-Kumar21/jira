            ...
            <div className="flex w-full">
                ...
                <div className="flex flex-col md:flex-row gap-4 w-full">
                    ...
                    <div className="flex flex-col gap-6 w-full md:w-[40%]">
                        <span className="flex w-full text-6xl font-medium leading-tight">Where your teams and AI come together</span>
                        <div className="flex flex-col gap-2">
                            <span className="text-sm font-semibold">Work email</span>
                            <input type="email" className="rounded-full border border-gray-400 px-4 py-2 text-base" placeholder="you@company.com" />
                        ...
                        <div className="flex ml-auto mr-auto gap-1">
                            <span className="text-sm">Trying to access Jira?</span>
